...
for ($i=0; $i <count($_SESSION['dataMD_bulan']); $i++) { 
	$_SESSION['prob_MD_Januari'][$i] = round($_SESSION['dataMD_bulan'][$i]['Januari']['data_bulan'] / $_SESSION['jumlahFrekuensiMD_Januari'],3);
	$_SESSION['jumlah_prob_Januari_MD'] += $_SESSION['prob_MD_Januari'][$i];


	$_SESSION['prob_MD_Februari'][$i] = round($_SESSION['dataMD_bulan'][$i]['Februari']['data_bulan'] / $_SESSION['jumlahFrekuensiMD_Februari'],3);
	$_SESSION['jumlah_prob_Februari_MD'] += $_SESSION['prob_MD_Februari'][$i];


	$_SESSION['prob_MD_Maret'][$i] = round($_SESSION['dataMD_bulan'][$i]['Maret']['data_bulan'] / $_SESSION['jumlahFrekuensiMD_Maret'],3);	
	$_SESSION['jumlah_prob_Maret_MD'] += $_SESSION['prob_MD_Maret'][$i]; 


	$_SESSION['prob_MD_April'][$i] = round($_SESSION['dataMD_bulan'][$i]['April']['data_bulan'] / $_SESSION['jumlahFrekuensiMD_April'],3);
	$_SESSION['jumlah_prob_April_MD'] += $_SESSION['prob_MD_April'][$i]; 


	$_SESSION['prob_MD_Mei'][$i] = round($_SESSION['dataMD_bulan'][$i]['Mei']['data_bulan'] / $_SESSION['jumlahFrekuensiMD_Mei'],3);
	$_SESSION['jumlah_prob_Mei_MD'] += $_SESSION['prob_MD_Mei'][$i]; 


	$_SESSION['prob_MD_Juni'][$i] = round($_SESSION['dataMD_bulan'][$i]['Juni']['data_bulan'] / $_SESSION['jumlahFrekuensiMD_Juni'],3);
	$_SESSION['jumlah_prob_Juni_MD'] += $_SESSION['prob_MD_Juni'][$i]; 


	$_SESSION['prob_MD_Juli'][$i] = round($_SESSION['dataMD_bulan'][$i]['Juli']['data_bulan'] / $_SESSION['jumlahFrekuensiMD_Juli'],3);
	$_SESSION['jumlah_prob_Juli_MD'] += $_SESSION['prob_MD_Juli'][$i]; 


	$_SESSION['prob_MD_Agustus'][$i] = round($_SESSION['dataMD_bulan'][$i]['Agustus']['data_bulan'] / $_SESSION['jumlahFrekuensiMD_Agustus'],3);	
	$_SESSION['jumlah_prob_Agustus_MD'] += $_SESSION['prob_MD_Agustus'][$i]; 


	$_SESSION['prob_MD_September'][$i] = round($_SESSION['dataMD_bulan'][$i]['September']['data_bulan'] / $_SESSION['jumlahFrekuensiMD_September'],3);
	$_SESSION['jumlah_prob_September_MD'] += $_SESSION['prob_MD_September'][$i]; 


	$_SESSION['prob_MD_Oktober'][$i] = round($_SESSION['dataMD_bulan'][$i]['Oktober']['data_bulan'] / $_SESSION['jumlahFrekuensiMD_Oktober'],3);	
	$_SESSION['jumlah_prob_Oktober_MD'] += $_SESSION['prob_MD_Oktober'][$i]; 


	$_SESSION['prob_MD_November'][$i] = round($_SESSION['dataMD_bulan'][$i]['November']['data_bulan'] / $_SESSION['jumlahFrekuensiMD_November'],3);
	$_SESSION['jumlah_prob_November_MD'] += $_SESSION['prob_MD_November'][$i]; 

	$_SESSION['prob_MD_Desember'][$i] = round($_SESSION['dataMD_bulan'][$i]['Desember']['data_bulan'] / $_SESSION['jumlahFrekuensiMD_Desember'],3);		
...
for ($i=0; $i <count($_SESSION['dataLB_bulan']); $i++) { 
	$_SESSION['prob_LB_Januari'][$i] = round($_SESSION['dataLB_bulan'][$i]['Januari']['data_bulan'] / $_SESSION['jumlahFrekuensiLB_Januari'],3);
	$_SESSION['jumlah_prob_Januari_LB'] += $_SESSION['prob_LB_Januari'][$i];


	$_SESSION['prob_LB_Februari'][$i] = round($_SESSION['dataLB_bulan'][$i]['Februari']['data_bulan'] / $_SESSION['jumlahFrekuensiLB_Februari'],3);
	$_SESSION['jumlah_prob_Februari_LB'] += $_SESSION['prob_LB_Februari'][$i];


	$_SESSION['prob_LB_Maret'][$i] = round($_SESSION['dataLB_bulan'][$i]['Maret']['data_bulan'] / $_SESSION['jumlahFrekuensiLB_Maret'],3);	
	$_SESSION['jumlah_prob_Maret_LB'] += $_SESSION['prob_LB_Maret'][$i]; 


	$_SESSION['prob_LB_April'][$i] = round($_SESSION['dataLB_bulan'][$i]['April']['data_bulan'] / $_SESSION['jumlahFrekuensiLB_April'],3);
	$_SESSION['jumlah_prob_April_LB'] += $_SESSION['prob_LB_April'][$i]; 


	$_SESSION['prob_LB_Mei'][$i] = round($_SESSION['dataLB_bulan'][$i]['Mei']['data_bulan'] / $_SESSION['jumlahFrekuensiLB_Mei'],3);
	$_SESSION['jumlah_prob_Mei_LB'] += $_SESSION['prob_LB_Mei'][$i]; 


	$_SESSION['prob_LB_Juni'][$i] = round($_SESSION['dataLB_bulan'][$i]['Juni']['data_bulan'] / $_SESSION['jumlahFrekuensiLB_Juni'],3);
	$_SESSION['jumlah_prob_Juni_LB'] += $_SESSION['prob_LB_Juni'][$i]; 


	$_SESSION['prob_LB_Juli'][$i] = round($_SESSION['dataLB_bulan'][$i]['Juli']['data_bulan'] / $_SESSION['jumlahFrekuensiLB_Juli'],3);
	$_SESSION['jumlah_prob_Juli_LB'] += $_SESSION['prob_LB_Juli'][$i]; 


	$_SESSION['prob_LB_Agustus'][$i] = round($_SESSION['dataLB_bulan'][$i]['Agustus']['data_bulan'] / $_SESSION['jumlahFrekuensiLB_Agustus'],3);	
	$_SESSION['jumlah_prob_Agustus_LB'] += $_SESSION['prob_LB_Agustus'][$i]; 


	$_SESSION['prob_LB_September'][$i] = round($_SESSION['dataLB_bulan'][$i]['September']['data_bulan'] / $_SESSION['jumlahFrekuensiLB_September'],3);
	$_SESSION['jumlah_prob_September_LB'] += $_SESSION['prob_LB_September'][$i]; 


	$_SESSION['prob_LB_Oktober'][$i] = round($_SESSION['dataLB_bulan'][$i]['Oktober']['data_bulan'] / $_SESSION['jumlahFrekuensiLB_Oktober'],3);	
	$_SESSION['jumlah_prob_Oktober_LB'] += $_SESSION['prob_LB_Oktober'][$i]; 


	$_SESSION['prob_LB_November'][$i] = round($_SESSION['dataLB_bulan'][$i]['November']['data_bulan'] / $_SESSION['jumlahFrekuensiLB_November'],3);
	$_SESSION['jumlah_prob_November_LB'] += $_SESSION['prob_LB_November'][$i]; 

	$_SESSION['prob_LB_Desember'][$i] = round($_SESSION['dataLB_bulan'][$i]['Desember']['data_bulan'] / $_SESSION['jumlahFrekuensiLB_Desember'],3);		
...
for ($i=0; $i <count($_SESSION['dataLR_bulan']); $i++) { 
	$_SESSION['prob_LR_Januari'][$i] = round($_SESSION['dataLR_bulan'][$i]['Januari']['data_bulan'] / $_SESSION['jumlahFrekuensiLR_Januari'],3);
	$_SESSION['jumlah_prob_Januari_LR'] += $_SESSION['prob_LR_Januari'][$i];


	$_SESSION['prob_LR_Februari'][$i] = round($_SESSION['dataLR_bulan'][$i]['Februari']['data_bulan'] / $_SESSION['jumlahFrekuensiLR_Februari'],3);
	$_SESSION['jumlah_prob_Februari_LR'] += $_SESSION['prob_LR_Februari'][$i];


	$_SESSION['prob_LR_Maret'][$i] = round($_SESSION['dataLR_bulan'][$i]['Maret']['data_bulan'] / $_SESSION['jumlahFrekuensiLR_Maret'],3);	
	$_SESSION['jumlah_prob_Maret_LR'] += $_SESSION['prob_LR_Maret'][$i]; 


	$_SESSION['prob_LR_April'][$i] = round($_SESSION['dataLR_bulan'][$i]['April']['data_bulan'] / $_SESSION['jumlahFrekuensiLR_April'],3);
	$_SESSION['jumlah_prob_April_LR'] += $_SESSION['prob_LR_April'][$i]; 


	$_SESSION['prob_LR_Mei'][$i] = round($_SESSION['dataLR_bulan'][$i]['Mei']['data_bulan'] / $_SESSION['jumlahFrekuensiLR_Mei'],3);
	$_SESSION['jumlah_prob_Mei_LR'] += $_SESSION['prob_LR_Mei'][$i]; 


	$_SESSION['prob_LR_Juni'][$i] = round($_SESSION['dataLR_bulan'][$i]['Juni']['data_bulan'] / $_SESSION['jumlahFrekuensiLR_Juni'],3);
	$_SESSION['jumlah_prob_Juni_LR'] += $_SESSION['prob_LR_Juni'][$i]; 


	$_SESSION['prob_LR_Juli'][$i] = round($_SESSION['dataLR_bulan'][$i]['Juli']['data_bulan'] / $_SESSION['jumlahFrekuensiLR_Juli'],3);
	$_SESSION['jumlah_prob_Juli_LR'] += $_SESSION['prob_LR_Juli'][$i]; 


	$_SESSION['prob_LR_Agustus'][$i] = round($_SESSION['dataLR_bulan'][$i]['Agustus']['data_bulan'] / $_SESSION['jumlahFrekuensiLR_Agustus'],3);	
	$_SESSION['jumlah_prob_Agustus_LR'] += $_SESSION['prob_LR_Agustus'][$i]; 


	$_SESSION['prob_LR_September'][$i] = round($_SESSION['dataLR_bulan'][$i]['September']['data_bulan'] / $_SESSION['jumlahFrekuensiLR_September'],3);
	$_SESSION['jumlah_prob_September_LR'] += $_SESSION['prob_LR_September'][$i]; 


	$_SESSION['prob_LR_Oktober'][$i] = round($_SESSION['dataLR_bulan'][$i]['Oktober']['data_bulan'] / $_SESSION['jumlahFrekuensiLR_Oktober'],3);	
	$_SESSION['jumlah_prob_Oktober_LR'] += $_SESSION['prob_LR_Oktober'][$i]; 


	$_SESSION['prob_LR_November'][$i] = round($_SESSION['dataLR_bulan'][$i]['November']['data_bulan'] / $_SESSION['jumlahFrekuensiLR_November'],3);
	$_SESSION['jumlah_prob_November_LR'] += $_SESSION['prob_LR_November'][$i]; 

	$_SESSION['prob_LR_Desember'][$i] = round($_SESSION['dataLR_bulan'][$i]['Desember']['data_bulan'] / $_SESSION['jumlahFrekuensiLR_Desember'],3);		
