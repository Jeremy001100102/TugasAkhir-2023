...
<body>
    <table>
        <caption class="caption-top text-center mb-2 judul">Data Hasil Simulasi Meninggal Dunia <?= $_SESSION['tahun_uji_MD']; ?></caption>
        <thead>
...
<body>
    <table>
        <caption class="caption-top text-center mb-2 judul">Data Hasil Simulasi Luka Berat <?= $_SESSION['tahun_uji_LB']; ?></caption>
        <thead>
            <tr class="text-center">
                <th class="no">No</th>
                <th class="bulan">Bulan</th>
...
<?php  if($_GET['id_convert'] == "LR") : ?>
    ...
    <body>
        <table>
           <caption class="caption-top text-center mb-2 judul">Data Hasil Simulasi Luka Ringan <?= $_SESSION['tahun_uji_LR']; ?></caption>
        <thead>
            <tr class="text-center">
                <th class="no">No</th>
                <th class="bulan">Bulan</th>
