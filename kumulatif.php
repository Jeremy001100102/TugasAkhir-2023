...
for ($i=0; $i < count($_SESSION['dataMD_bulan']); $i++) {
	$temp= 0;
	if ($i == 0) {
		$_SESSION['kumu_Januari_MD'][$i] = number_format($_SESSION['prob_MD_Januari'][$i], 3);
		$_SESSION['kumu_Februari_MD'][$i] = number_format($_SESSION['prob_MD_Februari'][$i],3);
		$_SESSION['kumu_Maret_MD'][$i] = number_format($_SESSION['prob_MD_Maret'][$i],3);
		$_SESSION['kumu_April_MD'][$i] = number_format($_SESSION['prob_MD_April'][$i],3);
		$_SESSION['kumu_Mei_MD'][$i] = number_format($_SESSION['prob_MD_Mei'][$i],3);
		$_SESSION['kumu_Juni_MD'][$i] = number_format($_SESSION['prob_MD_Juni'][$i],3);
		$_SESSION['kumu_Juli_MD'][$i] = number_format($_SESSION['prob_MD_Juli'][$i],3);
		$_SESSION['kumu_Agustus_MD'][$i] = number_format($_SESSION['prob_MD_Agustus'][$i],3);
		$_SESSION['kumu_September_MD'][$i] = number_format($_SESSION['prob_MD_September'][$i],3);
		$_SESSION['kumu_Oktober_MD'][$i] = number_format($_SESSION['prob_MD_Oktober'][$i],3);
		$_SESSION['kumu_November_MD'][$i] = number_format($_SESSION['prob_MD_November'][$i],3);
		$_SESSION['kumu_Desember_MD'][$i] = number_format($_SESSION['prob_MD_Desember'][$i],3);		
	}else{
		$temp = $_SESSION['prob_MD_Januari'][$i] + $_SESSION['kumu_Januari_MD'][$i-1];
		$_SESSION['kumu_Januari_MD'][$i] = number_format($temp, 3);
		$temp = $_SESSION['prob_MD_Februari'][$i] + $_SESSION['kumu_Februari_MD'][$i-1];
		$_SESSION['kumu_Februari_MD'][$i] = number_format($temp, 3);
		$temp = $_SESSION['prob_MD_Maret'][$i] + $_SESSION['kumu_Maret_MD'][$i-1];
		$_SESSION['kumu_Maret_MD'][$i] = number_format($temp, 3);
		$temp = $_SESSION['prob_MD_April'][$i] + $_SESSION['kumu_April_MD'][$i-1];
		$_SESSION['kumu_April_MD'][$i] = number_format($temp, 3);
		$temp = $_SESSION['prob_MD_Mei'][$i] + $_SESSION['kumu_Mei_MD'][$i-1];
		$_SESSION['kumu_Mei_MD'][$i] = number_format($temp, 3);
		$temp = $_SESSION['prob_MD_Juni'][$i] + $_SESSION['kumu_Juni_MD'][$i-1];
		$_SESSION['kumu_Juni_MD'][$i] = number_format($temp, 3);
		$temp = $_SESSION['prob_MD_Juli'][$i] + $_SESSION['kumu_Juli_MD'][$i-1];
		$_SESSION['kumu_Juli_MD'][$i] = number_format($temp, 3);
		$temp = $_SESSION['prob_MD_Agustus'][$i] + $_SESSION['kumu_Agustus_MD'][$i-1];
		$_SESSION['kumu_Agustus_MD'][$i] = number_format($temp, 3);
		$temp = $_SESSION['prob_MD_September'][$i] + $_SESSION['kumu_September_MD'][$i-1];
		$_SESSION['kumu_September_MD'][$i] = number_format($temp, 3);
		$temp = $_SESSION['prob_MD_Oktober'][$i] + $_SESSION['kumu_Oktober_MD'][$i-1];
		$_SESSION['kumu_Oktober_MD'][$i] = number_format($temp, 3);
		$temp = $_SESSION['prob_MD_November'][$i] + $_SESSION['kumu_November_MD'][$i-1];
		$_SESSION['kumu_November_MD'][$i] = number_format($temp, 3);
		$temp = $_SESSION['prob_MD_Desember'][$i] + $_SESSION['kumu_Desember_MD'][$i-1];
		$_SESSION['kumu_Desember_MD'][$i] = number_format($temp, 3);
...
for ($i=0; $i < count($_SESSION['dataLB_bulan']); $i++) {
	$temp= 0;
	if ($i == 0) {
		$_SESSION['kumu_Januari_LB'][$i] = number_format($_SESSION['prob_LB_Januari'][$i], 3);
		$_SESSION['kumu_Februari_LB'][$i] = number_format($_SESSION['prob_LB_Februari'][$i],3);
		$_SESSION['kumu_Maret_LB'][$i] = number_format($_SESSION['prob_LB_Maret'][$i],3);
		$_SESSION['kumu_April_LB'][$i] = number_format($_SESSION['prob_LB_April'][$i],3);
		$_SESSION['kumu_Mei_LB'][$i] = number_format($_SESSION['prob_LB_Mei'][$i],3);
		$_SESSION['kumu_Juni_LB'][$i] = number_format($_SESSION['prob_LB_Juni'][$i],3);
		$_SESSION['kumu_Juli_LB'][$i] = number_format($_SESSION['prob_LB_Juli'][$i],3);
		$_SESSION['kumu_Agustus_LB'][$i] = number_format($_SESSION['prob_LB_Agustus'][$i],3);
		$_SESSION['kumu_September_LB'][$i] = number_format($_SESSION['prob_LB_September'][$i],3);
		$_SESSION['kumu_Oktober_LB'][$i] = number_format($_SESSION['prob_LB_Oktober'][$i],3);
		$_SESSION['kumu_November_LB'][$i] = number_format($_SESSION['prob_LB_November'][$i],3);
		$_SESSION['kumu_Desember_LB'][$i] = number_format($_SESSION['prob_LB_Desember'][$i],3);		
	}else{
		$temp = $_SESSION['prob_LB_Januari'][$i] + $_SESSION['kumu_Januari_LB'][$i-1];
		$_SESSION['kumu_Januari_LB'][$i] = number_format($temp, 3);
		$temp = $_SESSION['prob_LB_Februari'][$i] + $_SESSION['kumu_Februari_LB'][$i-1];
		$_SESSION['kumu_Februari_LB'][$i] = number_format($temp, 3);
		$temp = $_SESSION['prob_LB_Maret'][$i] + $_SESSION['kumu_Maret_LB'][$i-1];
		$_SESSION['kumu_Maret_LB'][$i] = number_format($temp, 3);
		$temp = $_SESSION['prob_LB_April'][$i] + $_SESSION['kumu_April_LB'][$i-1];
		$_SESSION['kumu_April_LB'][$i] = number_format($temp, 3);
		$temp = $_SESSION['prob_LB_Mei'][$i] + $_SESSION['kumu_Mei_LB'][$i-1];
		$_SESSION['kumu_Mei_LB'][$i] = number_format($temp, 3);
		$temp = $_SESSION['prob_LB_Juni'][$i] + $_SESSION['kumu_Juni_LB'][$i-1];
		$_SESSION['kumu_Juni_LB'][$i] = number_format($temp, 3);
		$temp = $_SESSION['prob_LB_Juli'][$i] + $_SESSION['kumu_Juli_LB'][$i-1];
		$_SESSION['kumu_Juli_LB'][$i] = number_format($temp, 3);
		$temp = $_SESSION['prob_LB_Agustus'][$i] + $_SESSION['kumu_Agustus_LB'][$i-1];
		$_SESSION['kumu_Agustus_LB'][$i] = number_format($temp, 3);
		$temp = $_SESSION['prob_LB_September'][$i] + $_SESSION['kumu_September_LB'][$i-1];
		$_SESSION['kumu_September_LB'][$i] = number_format($temp, 3);
		$temp = $_SESSION['prob_LB_Oktober'][$i] + $_SESSION['kumu_Oktober_LB'][$i-1];
		$_SESSION['kumu_Oktober_LB'][$i] = number_format($temp, 3);
		$temp = $_SESSION['prob_LB_November'][$i] + $_SESSION['kumu_November_LB'][$i-1];
		$_SESSION['kumu_November_LB'][$i] = number_format($temp, 3);
		$temp = $_SESSION['prob_LB_Desember'][$i] + $_SESSION['kumu_Desember_LB'][$i-1];
		$_SESSION['kumu_Desember_LB'][$i] = number_format($temp, 3);
...
for ($i=0; $i < count($_SESSION['dataLR_bulan']); $i++) {
	$temp= 0;
	if ($i == 0) {
		$_SESSION['kumu_Januari_LR'][$i] = number_format($_SESSION['prob_LR_Januari'][$i], 3);
		$_SESSION['kumu_Februari_LR'][$i] = number_format($_SESSION['prob_LR_Februari'][$i],3);
		$_SESSION['kumu_Maret_LR'][$i] = number_format($_SESSION['prob_LR_Maret'][$i],3);
		$_SESSION['kumu_April_LR'][$i] = number_format($_SESSION['prob_LR_April'][$i],3);
		$_SESSION['kumu_Mei_LR'][$i] = number_format($_SESSION['prob_LR_Mei'][$i],3);
		$_SESSION['kumu_Juni_LR'][$i] = number_format($_SESSION['prob_LR_Juni'][$i],3);
		$_SESSION['kumu_Juli_LR'][$i] = number_format($_SESSION['prob_LR_Juli'][$i],3);
		$_SESSION['kumu_Agustus_LR'][$i] = number_format($_SESSION['prob_LR_Agustus'][$i],3);
		$_SESSION['kumu_September_LR'][$i] = number_format($_SESSION['prob_LR_September'][$i],3);
		$_SESSION['kumu_Oktober_LR'][$i] = number_format($_SESSION['prob_LR_Oktober'][$i],3);
		$_SESSION['kumu_November_LR'][$i] = number_format($_SESSION['prob_LR_November'][$i],3);
		$_SESSION['kumu_Desember_LR'][$i] = number_format($_SESSION['prob_LR_Desember'][$i],3);		
	}else{
		$temp = $_SESSION['prob_LR_Januari'][$i] + $_SESSION['kumu_Januari_LR'][$i-1];
		$_SESSION['kumu_Januari_LR'][$i] = number_format($temp, 3);
		$temp = $_SESSION['prob_LR_Februari'][$i] + $_SESSION['kumu_Februari_LR'][$i-1];
		$_SESSION['kumu_Februari_LR'][$i] = number_format($temp, 3);
		$temp = $_SESSION['prob_LR_Maret'][$i] + $_SESSION['kumu_Maret_LR'][$i-1];
		$_SESSION['kumu_Maret_LR'][$i] = number_format($temp, 3);
		$temp = $_SESSION['prob_LR_April'][$i] + $_SESSION['kumu_April_LR'][$i-1];
		$_SESSION['kumu_April_LR'][$i] = number_format($temp, 3);
		$temp = $_SESSION['prob_LR_Mei'][$i] + $_SESSION['kumu_Mei_LR'][$i-1];
		$_SESSION['kumu_Mei_LR'][$i] = number_format($temp, 3);
		$temp = $_SESSION['prob_LR_Juni'][$i] + $_SESSION['kumu_Juni_LR'][$i-1];
		$_SESSION['kumu_Juni_LR'][$i] = number_format($temp, 3);
		$temp = $_SESSION['prob_LR_Juli'][$i] + $_SESSION['kumu_Juli_LR'][$i-1];
		$_SESSION['kumu_Juli_LR'][$i] = number_format($temp, 3);
		$temp = $_SESSION['prob_LR_Agustus'][$i] + $_SESSION['kumu_Agustus_LR'][$i-1];
		$_SESSION['kumu_Agustus_LR'][$i] = number_format($temp, 3);
		$temp = $_SESSION['prob_LR_September'][$i] + $_SESSION['kumu_September_LR'][$i-1];
		$_SESSION['kumu_September_LR'][$i] = number_format($temp, 3);
		$temp = $_SESSION['prob_LR_Oktober'][$i] + $_SESSION['kumu_Oktober_LR'][$i-1];
		$_SESSION['kumu_Oktober_LR'][$i] = number_format($temp, 3);
		$temp = $_SESSION['prob_LR_November'][$i] + $_SESSION['kumu_November_LR'][$i-1];
		$_SESSION['kumu_November_LR'][$i] = number_format($temp, 3);
		$temp = $_SESSION['prob_LR_Desember'][$i] + $_SESSION['kumu_Desember_LR'][$i-1];
		$_SESSION['kumu_Desember_LR'][$i] = number_format($temp, 3);
						...
						<table class="table mb-0">
							...
							<thead>
								<tr class="table-dark text-center">
									<th class="col-12" colspan="5">Bulan</i></th>
								</tr>
						...
						<table class="table table-bordered table-sm mb-0">
							<thead>
								<tr class="table-secondary icon" data-bs-toggle="collapse" data-bs-target="#MDr4">
									<th colspan="5" style="border-left-color:blue;">April <i class="fa-solid fa-caret-down"></i></th>
								</tr>
