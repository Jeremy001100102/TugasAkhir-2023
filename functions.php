...
//data hasil simulasi
$data_hasil_simulasi_MC = mysqli_query($conn, "SELECT * FROM data_hasil_simulasi");
$rows_data_hasil_simulasi = []; 
while($rows_data_hasil = mysqli_fetch_assoc($data_hasil_simulasi_MC)){
  $rows_data_hasil_simulasi [] = $rows_data_hasil; 
}
...
function simpanHasil($data){
    global $conn, $rows_data_hasil_simulasi;
    $kategori = [$data['id_kategori_MD'], $data['id_kategori_LB'], $data['id_kategori_LR']];
    $tahun = [$data['tahun_hasilS_MD'], $data['tahun_hasilS_LB'], $data['tahun_hasilS_LR']];
